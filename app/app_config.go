...
import (
	"time"
	_ "vector/x/vector/module"
	vectormoduletypes "vector/x/vector/types"
			...
			Modules: []*appv1alpha1.ModuleConfig{
				...
				},
				{
					...
					Config: appconfig.WrapAny(&authmodulev1.Module{
						Bech32Prefix:             vectorconfig.Bech32PrefixAccAddr,
				...
				},
				{
					...
					Config: appconfig.WrapAny(&stakingmodulev1.Module{
						...
						Bech32PrefixValidator: vectorconfig.Bech32PrefixValAddr,
						Bech32PrefixConsensus: vectorconfig.Bech32PrefixConsAddr,
					}),
				},
				{
				...
				{
					Name:   vectormoduletypes.ModuleName,
					Config: appconfig.WrapAny(&vectormoduletypes.Module{}),
