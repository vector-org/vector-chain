...
#
# Examples:
# CHAIN_ID="localchain-1" HOME_DIR="~/.vector" BLOCK_TIME="1000ms" CLEAN=true sh scripts/test_node.sh
# CHAIN_ID="localchain-2" HOME_DIR="~/.vector" CLEAN=true RPC=36657 REST=2317 PROFF=6061 P2P=36656 GRPC=8090 GRPC_WEB=8091 ROSETTA=8081 BLOCK_TIME="500ms" sh scripts/test_node.sh
...
from_scratch () {
  ...
  # vector1efd63aw40lxf3n4mhf7dzhjkr453axur6wlkdg
  ...
  # vector1hj5fveer5cjtn4wd6wstzugjfdxzl0xpx6vjyp
  ...
  $BINARY genesis add-genesis-account $KEY 10000000$DENOM,900test --keyring-backend $KEYRING --append --home $HOME_DIR
  $BINARY genesis add-genesis-account $KEY2 10000000$DENOM,800test --keyring-backend $KEYRING --append --home $HOME_DIR
