...
HTTPS_GIT := github.com/vector-org/vector.git
...
ldflags = -X github.com/cosmos/cosmos-sdk/version.Name=vector \
...
ifeq (,$(shell which heighliner))
	...
	heighliner build -c vector --local -f chains.yaml
endif
...
set-testnet-configs:
	vectord config set client chain-id localchain-1
